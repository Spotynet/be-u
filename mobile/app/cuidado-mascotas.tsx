...
export default function CuidadoMascotasScreen() {
  ...
  return (
    <View style={[styles.container, {backgroundColor: colors.background}]}>
      ...
      <View style={[styles.header, {borderBottomColor: colors.border}]}>
        ...
        <Text style={[styles.headerTitle, {color: colors.foreground}]}>Cuidado Mascotas</Text>
        <View style={{width: 40}} />
      </View>
      ...
      <ScrollView
        ...
        <View style={styles.comingSoonContainer}>
          <View style={[styles.iconContainer, {backgroundColor: colors.primary + "15"}]}>
            <Ionicons name="paw" color={colors.primary} size={64} />
          </View>
          ...
          <Text style={[styles.comingSoonText, {color: colors.mutedForeground}]}>
            Estamos trabajando para traerte los mejores servicios de cuidado para tus peluditos
          </Text>

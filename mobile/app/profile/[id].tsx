...
import {providerApi, postApi, serviceApi, linkApi, profileCustomizationApi, groupSessionApi, PlaceProfessionalLink, api} from "@/lib/api";
...
export default function ProfileDetailScreen() {
  ...
  const [activeSection, setActiveSection] = useState<"team" | "services" | "group_sessions" | "details" | "hours">("services");
  ...
  const sections: Array<{
    key: "team" | "services" | "group_sessions" | "details" | "hours";
    label: string;
  }> = [
